...
class Teacher extends CI_Controller {
    ...
    public function joinClass(){
         ...
         if($result){
            ...
            // 选课
             $this->teacher_model->join_class($c_id,$s_id,$t_id,$t_name,$c_subject,$start_time,$c_address,$t_tel); 
            echo 'join';
        }       
    }
    ...
    //老师发布课程
     public function addClass(){
         ...
         $result=$this->teacher_model->add_class($id,$name,$grade,$subject,$describe,$price,$method,$time,$c_try,$address,$tel); 
    ...
    public function addGood(){
         $c_id=$this->input->get('c_id');
         $result=$this->teacher_model->add_good($c_id);      
        echo json_encode($result);
