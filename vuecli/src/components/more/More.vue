...
<template>
  ...
  <!-- header -->
    <div id="more-header">
      <!-- 更换皮肤 -->
      <router-link to="/more/change/skin"><img src="../../assets/img/change-skin.png" alt="" class="skin"></router-link>
      <!-- 编辑个人信息 -->
      <router-link to="/more/my_info"><img src="../../assets/img/edit-info.png" alt="" class="edit" ></router-link>
    <!-- 已登录 -->
      <div id="logined" v-show="login">
        <img :src="info.img" class="pic" v-show="login"><br>
        <b class="name">{{info.name}}</b>&nbsp;&nbsp;<span class="man" v-if="info.sex=='男'">♂</span><span class="woman" v-else>♀</span>
