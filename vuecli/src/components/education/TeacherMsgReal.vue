<template>
  <div id="details">
    ...
    <div class="banner">
      <img src="/static/img/skin/换肤1友谊唯美720.png" alt="">
    </div>
      <div class="details-img">
        <img :src='teacherMsg.img' alt="">
      </div>
      <div class="details-msg">
        <p class="details-name"><span class="teacher-name">{{teacherMsg.name}}</span>&nbsp;&nbsp;<span>{{teacherMsg.sex}}</span></p><span class="blank">|</span><img src="/static/img1/13icn_ida.png" alt="" ><span class="approve">实名认证</span>
    ...
    <div class="details-introduce">
      ...
      <div class="description">
        ...
        <ul id="intro">
          <li class="main"><span class="introduce">学&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;历：</span>{{teacherMsg.xueli}}</li>
    ...
    <div class="details-honor">
      ...
      <div id="tancen-img" v-if='flag1' @click='flag1=!flag1'>
          <div class="tancen-img">
             ...
             <p class="honor-content"><span>{{teacherHonor[index1].honor_medal}}</span><br><span>{{teacherHonor[index1].honor_time}}</span></p> 
          </div>
      </div>
      <!-- 弹层图片开始结束 -->
    </div>
