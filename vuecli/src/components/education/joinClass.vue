<template>
    <div id="join-class">
        ...
        <div class="content">
            ...
            <div class="bottom">
                <ul>
                    <li><span class="cls-list">年&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;级:</span>&nbsp;&nbsp;<span>{{classMsg.c_grade}}</span></li>
                    <li><span class="cls-list">科&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;目:</span>&nbsp;&nbsp;<span>{{classMsg.c_subject}}</span></li>
                    <li><span class="cls-list">说&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;明:</span>&nbsp;&nbsp;<span>{{classMsg.c_describe}}</span></li>
                    <li><span class="cls-list">价&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;格:</span>&nbsp;&nbsp;<span class="price">￥{{classMsg.c_price}}</span><span>/课时</span></li>
        ...
        <div class="footer">
            ...
            <!-- <el-button :plain="true" class="right" @click="toggle_join" v-if='flag'>选择课程</el-button> -->
            ...
            toggle_join:function(){
                if(!localStorage.id){
                  this.$message({
                    ...
                    Axios.get('http://localhost:3000/joinClass',   {
                        params:{
                          c_id:this.index,
                          s_id:localStorage.id,
