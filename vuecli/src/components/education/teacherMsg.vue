  ...
  <div id="teacher-msg" >
        ...
        <div id="header">
           <img src="/static/img1/23icn_back_gray .png" alt="" @click="back">
            <ul id="nav">
                <li ><router-link :to="'/teacher-msg/real/'+index" >简介</router-link></li>
                <li><router-link :to="'/teacher-msg/class/'+index" >课程</router-link></li>
                <li><router-link :to="'/teacher-msg/eva/'+index" >评价</router-link></li>
            </ul>
    ...
    <div id="tancen-img" v-if='flag2'>
          <div class="tancen-img">
            ...
            <div class="bottom">
              ...
              <div class="right" @click='flag2=false'>呼叫</div>
            </div>
          </div>
    </div>
      <!-- 弹层图片开始结束 -->
         ...
         <div class="tancen-img1">
            ...
            <div class="teacher-apply" v-for='(msg,index) in $store.state.classList'>
                ...
                <div class="right-apply">
                    ...
                    <router-link :to="'/join-class/'+msg.c_id" ><button>报名</button></router-link>
                </div>
            </div>
         </div>
    </div>
