...
//     store.clear();//清除全部 -->
    export default {
        ...
        mounted() {
            ...
            // var location_url='http://localhost:3000/index_teacher_list';
            // console.log(location_url);
            Axios.get('http://localhost:3000/index_teacher_list',{params:{
        ...
        methods: {
            ...
            years: function () {
                ...
                this.flag=!this.flag;
                if(this.flag){
                    Axios.get('http://localhost:3000/index_asc_year',{params:{
                        dowell:this.catalog
                    }}).then((res)=>{
                        // console.log(JSON.parse(res.data));
                        this.teacher_list=JSON.parse(res.data);
                    ...
                    Axios.get('http://localhost:3000/index_desc_year',{params:{
                        dowell:this.catalog
                    }}).then((res)=>{
                        // console.log('res');
                        this.teacher_list=JSON.parse(res.data);
            ...
            price:function(){
                ...
                // console.log(this);
                if(this.price_flag){
                    Axios.get('http://localhost:3000/index_asc_price',{params:{
                        dowell:this.catalog
                    }}).then((res)=>{
                        // console.log(JSON.parse(res.data));
                        this.teacher_list=JSON.parse(res.data);
                    ...
                    Axios.get('http://localhost:3000/index_desc_price',{params:{
                        dowell:this.catalog
                    }}).then((res)=>{
                        // console.log('res');
                        this.teacher_list=JSON.parse(res.data);
            ...
            focus:function(id){
                ...
                if(localStorage.id){
                    console.log(100000);
                    Axios.get('http://localhost:3000/index_change_focus',{params:{
                        s_id:this.s_id,
                        t_id:id
                    }}).then((res)=>{
                        console.log(1111);
